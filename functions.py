########################### My only function that is testable (simple test) ########################################
...
# The rest of the functions contain nestled functions #
